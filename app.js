...
const books = Object.freeze({
  A1: [
    ...
    { title: "The Tale of Benjamin Bunny", note: "Gutenberg", color: "#718b52" },
  ...
  A2: [
    ...
    { title: "The Celebrated Jumping Frog", note: "Gutenberg", color: "#6b7650" },
  ...
  B1: [
    ...
    { title: "An Occurrence at Owl Creek Bridge", note: "Gutenberg", color: "#555e4d" },
  ],
  B2: [
    { title: "The Yellow Wallpaper", note: "Gutenberg", color: "#8a743d" },
    { title: "The Murders in the Rue Morgue", note: "Gutenberg", color: "#41505d" },
    { title: "The Man Who Would Be King", note: "Gutenberg", color: "#735648" },
  ...
  C1: [
    ...
    { title: "Bartleby, the Scrivener", note: "Gutenberg", color: "#4f5960" },
    { title: "The Dead", note: "Gutenberg", color: "#4d5966" },
    { title: "The Turn of the Screw", note: "Gutenberg", color: "#545164" },
    { title: "The Beast in the Jungle", note: "Gutenberg", color: "#3e5b4a" },
  ],
  C2: [
    { title: "Heart of Darkness", note: "Gutenberg", color: "#263d3c" },
    { title: "The Garden Party", note: "Gutenberg", color: "#596548" },
    { title: "Araby", note: "Gutenberg", color: "#55465d" },
    { title: "The Figure in the Carpet", note: "Gutenberg", color: "#66513d" },
    { title: "The Secret Sharer", note: "Gutenberg", color: "#344f60" },
  ],
});
