...
HARRY_CHAPTERS = {
    ...
    11: {
        ...
        "audio": configured_path("DICTAI_CH11_AUDIO_ROOT", "/home/scpark/harry-concise-ch11/audio-a"),
        "audio_second": configured_path("DICTAI_CH11_AUDIO_SECOND_ROOT", "/home/scpark/harry-concise-ch11/audio-b"),
...
def youtube_page(request: Request) -> Response:
    if request.query_params.get("embed") == "1":
        ...
        source = source.replace('</head>', '<meta name="referrer" content="strict-origin-when-cross-origin"><link rel="stylesheet" href="/youtube-assets/youtube.css?v=local-1"></head>')
        source = re.sub(r'<script src="\./app\.js[^\"]*"></script>', '<script type="module" src="/youtube-assets/youtube.js?v=local-1"></script>', source)
