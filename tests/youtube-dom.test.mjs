...
$('replayButton').click();assert.equal(lastPlayer.loaded.videoId,data.video_id);assert.equal(lastPlayer.loaded.startSeconds,.88);assert.equal(lastPlayer.loaded.endSeconds,4.12);
